...
from trainer.ours_trainer import YOLOOurs2
...
if __name__ == "__main__":
    ...
    for i, (train_loader, val_loader, other_info) in enumerate(TasksGenerator(m_cfg, data_cfg, hparams, exp_type, save_stats)):
        ...
        if i>= 1:
            ...
            teacher_dict = torch.load(f"./results/model_task_{i-1}.pt")
            yolo_mind = YOLOOurs2(m_cfg, hparams=hparams, data_cfg_path_val = data_cfg_new_path,
        ...
        if i == 0:
            ...
            yolo_mind.load_model_prev_task("./results", i)
